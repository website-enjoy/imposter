...
const newDbString = `const wordDatabase = [
            ...
            { cat: 'funny', w1: 'تبهديلة', d1: 'موقف محرج يخلي الحومة كامل تضحك عليك', w2: 'الهمّة', d2: 'الرزانة والقدر اللي يخليك عزيز' },
            { cat: 'funny', w1: 'الشكشوكة', d1: 'حالة مخلطة ومعقدة كيما المقال في الصيف', w2: 'الصافي', d2: 'الأمر الواضح اللي ما فيه حتى تخلاط' },
            { cat: 'funny', w1: 'الزردة', d1: 'وليمة كبيرة فيها اللحم والبركة والنشاط', w2: 'الشرّ', d2: 'الجوع الكبير اللي يخليك تاكل الأخضر واليابس' },
            { cat: 'funny', w1: 'الحطة', d1: 'الأناقة الزايدة واللبسة اللي تضرب في العين', w2: 'التبهديل', d2: 'حالة يرفى لها، عكس الأناقة تماماً' },
            { cat: 'funny', w1: 'القوسطو', d1: 'المزاج العالي والراحة النفسية الكبيرة', w2: 'الزعاف', d2: 'الغضب اللي يطير القوسطو في ثانية' },
            { cat: 'funny', w1: 'الخلوة', d1: 'الراحة النفسية والهدوء بعيد على الغاشي', w2: 'الهوشة', d2: 'الصداع والقلق والحس والضجيج' },
            { cat: 'funny', w1: 'التشباك', d1: 'المشاكل المعقدة اللي تخرج من العدم', w2: 'التسليك', d2: 'إيجاد حل سحري ومؤقت في آخر دقيقة' },
            { cat: 'funny', w1: 'النية', d1: 'الإنسان الصادق اللي يمشي بقلبه الأبيض', w2: 'التقرعيج', d2: 'حب الاستطلاع الزايد وتتبع أخبار الناس' },
            { cat: 'funny', w1: 'الزوفري', d1: 'الإنسان اللي عايش حياته بلا نظام ولا قوانين', w2: 'المسڨم', d2: 'الإنسان المنظم اللي يمشي "بالكوس والمنقلة"' },
            { cat: 'funny', w1: 'القرطاسة', d1: 'حاجة شابة بزاف ولا سريعة كي الرصاصة', w2: 'الكارثة', d2: 'حاجة خاسرة ولا موقف ما فيه حتى أمل' },
            { cat: 'funny', w1: 'المنڨاش', d1: 'الإنسان اللي يدخل روحه في كل صغيرة وكبيرة', w2: 'الثقيل', d2: 'الإنسان اللي يطول باش يفهم ولا يتحرك' },
            { cat: 'funny', w1: 'التحلاب', d1: 'الاهتمام الزايد عن اللزوم بشخص ما', w2: 'النفخة', d2: 'التكبر والتعالي بلا فايدة' },
            { cat: 'funny', w1: 'التشيبة', d1: 'هدية صغيرة "تحت الطابلة" باش تمشي الحالة', w2: 'البركة', d2: 'الرزق القليل بصح فيه الخير بزاف' },
            { cat: 'funny', w1: 'الشيتة', d1: 'التملق الزايد للمسؤولين باش تنال الرضا', w2: 'الكلمة', d2: 'الرجولة والوفاء بالوعد مهما كان' },
            { cat: 'funny', w1: 'الخلاط', d1: 'الإنسان اللي يحب يدير المشاكل بين الناس', w2: 'الصافي', d2: 'الإنسان اللي قلبه حليب وما يحبش المشاكل' },
            { cat: 'funny', w1: 'البلعاط', d1: 'الإنسان اللي يعرف يهدر بزاف بصح كلامه ريح', w2: 'الصح', d2: 'الحقيقة المرة اللي ما فيهاش كذب' },
            { cat: 'funny', w1: 'الزهو', d1: 'أوقات الفرح والنشاط والضحك مع الحباب', w2: 'الغمّة', d2: 'ضيق الخاطر والحزن اللي يجي بلا سبة' },
            { cat: 'funny', w1: 'الزهر', d1: 'الحظ السعيد اللي يجي في وقته بلا تعب', w2: 'النحس', d2: 'الحظ السيء اللي يتبعك وين تروح' },
            { cat: 'funny', w1: 'القسرة', d1: 'القعدة الممتعة مع الصحاب والضحك ليل كامل', w2: 'التقلاق', d2: 'الخوف والتوتر من حاجة رح تسرى' },
            { cat: 'funny', w1: 'البريكول', d1: 'خدمة خفيفة ومؤقتة باش تسلك الحالة', w2: 'الخدمة', d2: 'العمل الرسمي والمتعوب عليه' },
            { cat: 'funny', w1: 'الدبزة', d1: 'العراك القوي والمشاكل اللي فيها "الزبيط"', w2: 'السماح', d2: 'العفو والصلح وتصفية القلوب' },
            { cat: 'funny', w1: 'الكورصة', d1: 'سباق سريع مع الوقت ولا مع الطاكسي', w2: 'التمهبيل', d2: 'فعل أشياء غريبة ومضحكة بلا عقل' },
            { cat: 'funny', w1: 'الڨصبة', d1: 'الفن الأصيل والألحان اللي تزهي الخاطر', w2: 'التحواس', d2: 'الخروج والتنزه واستكشاف البلايص' },
            { cat: 'funny', w1: 'الهدرة', d1: 'الكلام الكثير اللي ما يخلصش', w2: 'السكات', d2: 'الصمت الحكيم اللي يغني عن الكلام' },
            { cat: 'funny', w1: 'البوشي', d1: 'حاجة "كبيرة" ولا إنسان قوي بزاف', w2: 'الريشة', d2: 'حاجة خفيفة وسهلة ما تعييش قاع' },
            { cat: 'funny', w1: 'البلاصة', d1: 'المكان المفضل ولا الكرسي المحجوز', w2: 'الضيق', d2: 'المكان اللي ما يرفدش والو ويخنق' },
            { cat: 'funny', w1: 'المانيطة', d1: 'التحكم في الأمور (كيما ألعاب الفيديو)', w2: 'التلفيّة', d2: 'حالة الضياع وعدم معرفة الطريق' },
            { cat: 'funny', w1: 'التيكي', d1: 'الورقة الرابحة ولا التذكرة للنجاح', w2: 'الخسارة', d2: 'الفشل في الوصول للهدف المنشود' },
            { cat: 'funny', w1: 'الهدة', d1: 'الدخلة القوية اللي تبهر الجميع في الحومة', w2: 'الخرجة', d2: 'الفكرة الغريبة ولا التصرف غير المتوقع' },
            { cat: 'funny', w1: 'الزردوم', d1: 'الماكلة القوية اللي تشبع وتخليك ترقد', w2: 'الريجيم', d2: 'محاولة فاشلة لإنقاص الوزن في الجزائر' },
